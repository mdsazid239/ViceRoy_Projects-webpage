...
const Expectations = () => {
  ...
  return (
    <main className="w-full min-w-0 overflow-x-hidden bg-[#1d2723]">
      <section
        className="
          relative
          isolate
      ...
      >
        ...
        >
          ...
          <div className="mt-5 space-y-2 text-[12px] font-medium leading-5 sm:text-sm md:text-[15px] lg:text-base xl:text-[17px] 2xl:text-lg">
